...
import com.soriole.dht.kademlia.exceptions.ContentExistException;
...
import com.soriole.dht.kademlia.util.serializer.KadSerializer;
...
public class DHT implements KademliaDHT {
    ...
    private StoredContentManager contentManager;
    private KadSerializer<JKademliaStorageEntry> serializer = null;
    ...
    @Override
    public JKademliaStorageEntry get(KademliaStorageEntryMetadata entry) throws IOException {
        try {
            return this.retrieve(entry.getKey(), entry.hashCode());
        } catch (FileNotFoundException e) {
            logger.error("Error while loading file for content", e);
        } catch (ClassNotFoundException e) {
            logger.error("The class for some content was not found", e);
        }
    ...
    @Override
    public JKademliaStorageEntry get(GetParameter param) throws IOException {
        ...
        try {
            ...
            logger.error("Error while loading file for content. Message: ", e);
        } catch (ClassNotFoundException e) {
            logger.error("The class for some content was not found. Message: ", e);
        }
